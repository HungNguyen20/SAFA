...
def read_option():
    ...
    # Proposal
    parser.add_argument('--lambda', help="Regularization factor used in FedCL", type=float, default='0.01')
    parser.add_argument('--offset', help="Communication round interval used in FedCL", type=int, default=10)
    parser.add_argument('--retain', help="Retain cycles in FedCL", type=int, default=20)
...
class Logger:
    ...
    def save(self, filepath):
        ...
        with open(filepath, 'w') as outf:
            self.output['time_buf'] = self.time_buf
