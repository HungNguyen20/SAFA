...
LAMBDA=0.5
ALPHA=0.95
GROUP="cifar10_cnn_u0.65_sparsity0.88_scarcity0.45_N500_K25_E10_B8"
ALG="testv1"
MODEL="cnn"
WANDB=1
ROUND=5000
...
NUM_GPUS=1
SERVER_GPU_ID=0
TASK="cifar10_cnn_u0.65_sparsity0.88_scarcity0.45_N500_K25_E10_B8"
IDX_DIR="cifar10/ablation/500client/u0.65_sparsity0.88_scarcity0.45"
