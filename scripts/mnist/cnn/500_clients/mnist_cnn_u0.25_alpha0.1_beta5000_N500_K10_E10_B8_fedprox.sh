...
#$ -l rt_G.small=1
#$ -l h_rt=72:00:00
#$ -o /home/aaa10078nj/Federated_Learning/folder-name/logs/mnist/$JOB_NAME_$JOB_ID.log
#$ -j y
...
python --version
LOG_DIR="/home/aaa10078nj/Federated_Learning/folder-name/logs/mnist/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
#Dataset
DATA_DIR="$SGE_LOCALDIR/$JOB_ID/"
cp -r ../AAAI2023/easyFL/benchmark/mnist/data ${DATA_DIR}

GROUP="mnist_cnn_u0.25_alpha0.1_beta5000_N500_K10_E10_B8"
ALG="fedprox"
MODEL="cnn"
WANDB=1
ROUND=3000
...
NUM_GPUS=1
SERVER_GPU_ID=0
TASK="mnist_cnn_u0.25_alpha0.1_beta5000_N500_K10_E10_B8"
IDX_DIR="mnist/new/500client/u0.25_alpha0.1_beta5000"
