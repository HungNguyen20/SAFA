...
class ClassifyCalculator(BasicTaskCalculator):
    ...
    def get_data_loader(self, dataset, batch_size=64, shuffle=True, droplast=False, num_workers=0):
        if self.DataLoader == None:
            raise NotImplementedError("DataLoader Not Found.")
        return DataLoader(dataset, batch_size=batch_size, shuffle=shuffle, drop_last=droplast, num_workers=num_workers)
...
class CusTomTaskReader(BasicTaskReader):
    ...
    def read_data(self):
        ...
        return local_train_datas, local_train_datas, server_test_data, n_clients
